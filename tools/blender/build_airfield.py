...
# 分散停機位：支線兩側各四個，44 m 見方
SPOTS = [(-960, -120), (-816, -120), (-960, -250), (-816, -250),
         (-960, -380), (-816, -380), (-960, -510), (-816, -510),
         (640, 360), (784, 360), (640, 480), (784, 480),
         (640, 600), (784, 600), (640, 720), (784, 720)]
HARDSTANDS = [(x - 22, z - 22, x + 22, z + 22) for x, z in SPOTS]
PAVED = [RUNWAY, TAXIWAY] + TAXI_LINKS + HARDSTANDS
# 停放的 B-17：停機位 16 架 + 滑行道南側 8 架
PARKED = SPOTS + [(-1050 + k * 200, 340) for k in range(8)]
