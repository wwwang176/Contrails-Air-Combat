...
RUNWAY = (-750.0, -30.0, 750.0, 30.0)       # x0, z0, x1, z1
APRON = (350.0, 60.0, 850.0, 360.0)
PARKED = [(396 + k * 36, 110 + r * 100) for r in range(3) for k in range(8)]
DUMPS = [(-700, -450, 16, 11), (-640, -450, 16, 11), (700, 500, 12, 7)]   # dx, dz, 半寬, 半深
