...
/**
 * 零戰的爆戦掛載：翼下兩個掛架，各一顆九九式二番 60 kg。**不在預設表上**，
 * 由任務卡依機種指定（盟 M3 沖繩外海）。
 *
 * 【60 kg 彈的 1,000 不照當量，照它對船的效果】照當量是 2,300，那讓零戰
 * 一批批投下來 26 發直擊就沉一艘 Essex —— 玩家掛機四分鐘航母就沉。史實上
 * 60 kg 彈打不沉航母，炸的是飛行甲板與起火。1,000 之下零戰單靠自己沉不了船
 * （六批打完 Essex 剩五成多），收尾要靠陸攻的魚雷 —— 炸彈削、魚雷殺。殺傷
 * 半徑跟著傷害縮（`blastScaleOf`）。**起始值，由試飛裁定。**
 *
 * 【中線那個 250 kg 沒有做】機腹掛架平常掛 330 L 副油箱，換成炸彈是神風
 * 攻擊的裝法 —— 那是一整套自殺衝撞的行為，與現有的攻擊航路是兩回事。
 */
export const A6M5_BOMB_LOADOUT: Loadout = {
