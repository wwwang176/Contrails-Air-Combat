 ...
 * 反映在 `sight` 算出來的預瞄環上。
 *
 * 【單發傷害的 ×3 慣例】2026-08-09 專案負責人決定三個單發傷害一律 ×3
 *（見 weapons.test.ts）。250 已經是 ×3 之後的值，等價基準值 83.3。
 */
 ...
 *
 * 【外型是 E-4、武裝是 K-4】專案負責人裁決：飛行模型與武裝用 K-4、
 * 參考模型是 E-4（見 specs/bf109k4.ts 檔頭）。E-4 的機首是兩挺 MG 17、
