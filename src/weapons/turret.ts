...
/**
 * 砲塔傷害的倍率。**專案負責人 2026-08-21 兩次裁定，各減一半。**
 *
 * ```
 ...
 * ```
 *
 * 【為什麼寫成兩行而不是直接記 0.25】兩次是兩個不同場合的裁定 —— 第一次
 * 是遭遇戰裡對上一群 B-17，第二次是護送任務讓四架轟炸機長時間貼著戰場。
 * 記成一個數字的話，日後只知道「有人覺得太痛」，不知道是哪一種局面太痛。
 *
 ...
 * 腹部砲塔由 18 × 2 = 36 變成 **9**。
 */
export const TURRET_DAMAGE_SCALE = 0.25
