  ...
  for (let i = 0; i < turrets.length; i++) {
    ...
    for (let n = 0; n < shots; n++) {
      ...
      projectiles.spawn(
        ...
        c.team === 'blue' ? 0 : 1, PROJECTILE_LIFETIME, t.weapon.caliber,
      )
    }
  }
}
 ...
 * 開火」，而且沒有任何錯誤。
 *
 * 【餘量不可以只給 400】「相對接近速度」是**兩台加起來**：B-17 巡航 160 m/s
 * 加上俯衝進場的 P-51 300 m/s 就是 460。400 的假陰性區間是
 * **1464.4 … 1616.4 m，寬 152 m** —— 在那一段
