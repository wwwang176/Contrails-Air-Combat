 ...
 * 追擊：敵機**咬在六點鐘**，兩隊同向。
 *
 * 【為什麼有這一種】撤離任務直飛就過關（任務框架 spec §8.6），成因是對頭
 * 交錯之後追兵得反轉再追，而玩家開的又是全場最快的東西。專案負責人
 * 2026-08-16 裁定改開局幾何：把敵機放到身後。
 *
 ...
 * ```
 *
 * **設計意圖換了**：不再指望他們「追上來」，而是讓他們**開局就已經在射擊
 * 位置上**。玩家必須閃，而閃就是掉速度、掉速度就是掉時間 —— 壓力來自
 * 倒數，不是來自被追上。跑掉本來就是撤離該有的結局。
 *
