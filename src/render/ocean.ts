 ...
 *
 * 【為什麼需要】霧淡的時段 20 km 外的霧只有幾成，一塊反光仍然和眼前那塊差不多
 * 白。真實的遠處反光要穿過整段大氣才到眼睛，散射把它稀釋掉，對比也被前向散射
 * 的氣柱壓平。這一層只作用在碎光的加法項上，疊在霧之前。
 *
 ...
 * 近深遠淺、柔和融入天空。
 *
 * 【它與霧的關係】霧照距離化、這一層照仰角化；霧淡的時段主要是這一層在給地平線
 * 空氣感。
 *
