 ...
 * 魚雷的航跡 —— **貼著海面的一條白帶**。
 *
 * 【為什麼不是粒子】這個專案為凝結尾解過同一個問題，而且留了負責人的原話：
 * 「煙霧沒辦法連續，看起來就會像是一點一點的圈圈」（見 `vortex.ts`）。
 * 粒子池是畫**團狀**東西的（煙、爆炸、水花）；航跡是一條**線**。水花仍然
 * 留著 —— 它負責線上的閃爍，帶子負責那條線。
 *
 * 【為什麼是平帶不是管】負責人 2026-09-06。泡沫是浮在水面上的一層，管子
 * 有厚度、會有一半沉在水裡，而露出來的那半在遠處讀起來像一根白棍。
 *
