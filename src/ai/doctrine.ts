...
export interface DoctrineConfig {
   ...
   * 俯衝逃跑的瞬時速度當成實力。
   *
   * 【實測的荒謬案例，2026-08-24】護送關交會後：109 在 P-51 **上方
   * 1,052 m**，物理帳卻讀出 −95（對方帶著俯衝速度）→ 能量閂鎖把意圖
   * 鎖在 extend，109 對著正下方 600 m 的獵物平飛不理，人工回報「進入
   * 射程也沒有低頭攻擊」。權重 0.1 時同一格帳面約 +950 —— 不觸發。
   *
   * 【專案負責人 2026-08-24 裁定】「能量中高度占九成、速度占一成。」
   */
