...
| 日 M2 | `japan-m2` | 雷伊泰前線 | 打擊 | Ki-84 ×8（250 kg ×2） | F6F-5（只由波次給） | 敵方車隊 3 批 × 5 輛沿公路開往前線 | leyte・1,500 m | `interdict`：炸 6 輛卡車 → 撤離；卡車抵達 4 輛判敗 | 摧毀 ≥1（90 s 兜底）F6F ×4；摧毀 ≥6 時 F6F ×4 堵在退路上＋返航 | `japan.ts:77` |
