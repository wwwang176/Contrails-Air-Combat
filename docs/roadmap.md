...
| 日 M2 | `japan-m2` | 雷伊泰前線 | 打擊 | Ki-84 ×8（250 kg ×2） | F6F-5 ×2 巡邏，其餘由波次給 | 敵方車隊 3 批 × 6 輛（防空車頭尾各一）沿公路開往前線；灘頭與前線 5 座固定砲位 | leyte・1,500 m | `interdict`：炸 6 輛卡車 → 撤離（11 km、半徑 600 m）；卡車抵達 4 輛判敗 | 摧毀 ≥1（90 s 兜底）F6F ×4；摧毀 ≥6 時 F6F ×4 從背後追、×4 在撤退路上從高處堵＋返航 | `japan.ts:77` |
