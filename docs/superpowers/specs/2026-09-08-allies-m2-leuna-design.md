...
| GLB | 3.01 MB | 4.10 MB |
| 墊面俯視覆蓋率 | 46.8% | 69.2% |
| 非 `open` 街廓的最大空洞 | 35–165 m | 30–65 m |
| 離最近的東西 >50 m 的地 | 調車場 20–26% | 全部 0% |
| 儲槽區 2041 | 41,220 | 25,064 |

實測（1600×900、DPR 1）：2.5 km 投彈高度 frame 1.50 ms / 64 draw call、
600 m 航線 1.03 ms / 59、200 m 貼地 0.77 ms / 46。

### 17.7 開放項（負責人裁決）

- 護欄的三角形上限仍是 40 萬，現在用掉 75.6%。實測幀時間離會痛還很遠，
  要不要再放寬是負責人的事。
- 俯視覆蓋率的護欄仍是 ≥ 35% / 逐街廓 ≥ 25%，而實測已經是 69.2% / 60.3%。
