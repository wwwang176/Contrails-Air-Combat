...
史實上 TF 18 接戰時是 **12 艘**：三重巡（Wichita、Chicago、Louisville）、
三輕巡（Montpelier、Cleveland、Columbia）排成兩列縱隊，六艘驅逐艦在前方
張開半圓形警戒幕。兩艘護航航母跟不上 24 節，**開打前就被留在後面** ——
那也是那一夜沒有空中掩護的原因。

遊戲裡放 **8 艘**（負責人裁定），巡洋與驅逐各四，維持史實的一比一。
不放滿 12 是因為**只有兩個艦級模型**，12 艘會讓重複太明顯。

| 艦 | 數量 | 砲區 | 5" / 40 mm / 20 mm |
|---|---|---|---|
| Wichita CA-45 | 4 | 8 | 2 / 2 / 4 |
| Fletcher DD-445 | 4 | 6 | 1 / 1 / 4 |

合計 **56 個砲區**：12 個 5 吋、12 個 40 mm、32 個 20 mm。
...
**這是防空序列的緊端，不是隨便訂的。** 美軍 1943–45 年的實務：縱隊裡的
主力艦彼此 450–900 m，護衛幕在距核心 1,400–2,700 m，而**遭空襲時會刻意
收緊到 1,400–1,800 m 讓火網重疊** —— 收緊正是那個序列的目的。

> 【試飛裁定：四艘 3 km → 八艘 1.8 km】原本是四艘、兩巡相距 800 m、驅逐
> 外張 1,500 m。負責人：「船艦的密度太低，所以看起來無感」——遠看是四個
> 分開的小點，不是一支艦隊。艦數加倍、間距收緊，兩件事一起做。
...
|---|---|---|---|---|---|---|---|---|---|
| `mg` | 20 mm Oerlikon | 830 | 480 /分 | 1.6 s | 1,330 m | 5 | 60 | 2.4 m 立方 | 60°/s |
| `autocannon` | 40 mm Bofors | 880 | 220 /分 | 3.4 s | 2,990 m | 18 | 120 | 4.0 m 立方 | 45°/s |
...
> 【試飛裁定一：兩層直射的射速加倍】240 → 480、110 → 220。**加倍之後反而
> 更接近真砲**：Oerlikon 的循環射速本來就是每分鐘 450 發上下，而 Bofors
> 每管 120 發、四聯裝理論值 480（取 220 是打打停停的實況值）。
>
> 【試飛裁定二：40 mm 的射程拉到 3 km】彈丸壽命 2.4 → 3.4 秒。原本的
> 2,110 m 比史實有效射程（2.7–3.5 km）短三成，而且與 20 mm 的 1,330 m
> 疊得太近、讀不出層次。**初速不動**，只延長飛行時間。
>
> 【試飛裁定三：單發傷害降到 5 / 18】艦數從四加到八，20 mm 砲區從 16 變成
> 32、每秒 256 發。傷害不跟著降的話總 DPS 翻倍，而要的是**視覺密度**變厚、
> 不是進去就死。降完之後直射總 DPS 是 2,072（四艘時代是 2,416），
> 同時在空中約 515 發（池 4,000）。
