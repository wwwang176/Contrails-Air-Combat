...
兩艘重巡並列在中央（相距 500 m），兩艘驅逐在前方兩側外張（前方 700 m、
外側 700 m）。整隊橫跨 1.4 km，同一艏向、同一航速。

**這是防空序列的緊端，不是隨便訂的。** 美軍 1943–45 年的實務：縱隊裡的
主力艦彼此 450–900 m，護衛幕在距核心 1,400–2,700 m，而**遭空襲時會刻意
收緊到 1,400–1,800 m 讓火網重疊** —— 收緊正是那個序列的目的。

> 【試飛裁定：從 3 km 收到 1.4 km】原本兩巡 800 m、驅逐外張 1,500 m 前方
> 1,200 m，仍在史實區間但落在鬆的那一端。負責人：「船艦的密度太低，所以
> 看起來無感」——遠看是四個分開的小點，不是一支艦隊。
...
|---|---|---|---|---|---|---|---|---|---|
| `mg` | 20 mm Oerlikon | 830 | 480 /分 | 1.6 s | 1,330 m | 12 | 60 | 2.4 m 立方 | 60°/s |
| `autocannon` | 40 mm Bofors | 880 | 220 /分 | 2.4 s | 2,110 m | 40 | 120 | 4.0 m 立方 | 45°/s |
...
> 【試飛裁定：兩層直射的射速加倍】240 → 480、110 → 220。**加倍之後反而
