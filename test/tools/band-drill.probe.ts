...
const OPENINGS: Record<string, Opening> = {
  ...
  /**
   * 【補償器的欺敵對照局】尾追 500 m、靶機做 S 繞（6 s 週期、
  ...
  /**
   * 【實戰回報】P-51 在 4800 m，敵方 Bf 109
   * 在下方**射程內**，卻死不低頭攻擊，最後觸發 extend(迴旋) 平飛離開。
