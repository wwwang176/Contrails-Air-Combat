 ...
 *
 * 順帶一提：那 22 組掃描用的正是這個 120 秒窗口，而撤退令的
...
describe('指令通道（20v20、300 秒）', () => {
   ...
   * 「停止出擊」限制關掉之後（`AiController` 裡那一行），實測
