...
describe('L4-C 能量戰證據', () => {
   ...
   * 回傳 0。這條的紅燈完全來自破防軸。
   *
   * 【真正把它拉回來的是 `brakeCornerRatio`，2026-08-07】手感重調後的
   ...
   * 真正的死拉會是幾乎連續的大負 Ps。
   *
   * ## 2026-08-16：門檻由 0.75 放寬到 0.95，專案負責人裁定
   *
   ...
   *
   * 專案負責人的裁定：**這個遊戲主要看玩家體感，戰鬥時間不是第一重要**，
